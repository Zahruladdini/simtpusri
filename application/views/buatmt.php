...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <center><a href="<?php echo base_url()?>index.php/home"> <img  src="<?php echo base_url()?>/assets/img/pusri.png" width="80"></a></center>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        ...
                        <div class="panel-heading">
                           FORM PEMBUATAN MANAJEMEN TRAINEE BARU
                        </div>
                        <div class="panel-body">
                       <form method="post" action="<?php echo base_url()?>index.php/daftarmt/tambah">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="jalur" placeholder="Jalur" required />
  </div>
  <div class="form-group">
    <label for="exampleInputBatch">Batch</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="batch" placeholder="Batch" required />
  </div>
  <div class="form-group">
